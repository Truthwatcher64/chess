...
public class EscapeSequences {
    ...
    public static final String SET_TEXT_COLOR_LIGHT_TAN = SET_TEXT_COLOR + "179m";
    public static final String SET_TEXT_COLOR_DARK_TAN = SET_TEXT_COLOR + "94m";
    ...
    public static final String SET_BG_COLOR_PURPLE = SET_BG_COLOR + "99m";
